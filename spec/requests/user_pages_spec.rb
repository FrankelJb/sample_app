...
describe "User pages" do
  ...
  describe "index" do
    ...
    describe "delete links" do
      ...
      describe "should not allow admin to delete himself" do
        let(:admin) { FactoryGirl.create(:admin) }
    ...
    describe "unfollow/follow buttons" do
    ...
    describe "with valid information" do
      before { fill_fields(name: "Example User", email: "user@example.com", password: "foobar") }
  ...
  describe "edit" do
    ...
    describe "with valid information" do
      ...
      before do
       fill_fields(name: new_name, email: new_email, password: "foobar")
  ...
  describe "profile page" do
    ...
    describe "pagination" do
      ...
      before(:all) do
        ...
        35.times { FactoryGirl.create(:micropost, user: @another_user) } 
      end
